...
public:
    ...
    void readJsonComments(std::ifstream &file);
...
private:
    ...
    CommentNode* findComment(const std::string& comment_id);
    ...
    void addReplyToComment(const std::string& parent_id, const std::string& reply_id, const std::string& username, const std::string& reply_text);
    void addReplyToVideo(const std::string& reply_id, const std::string& username, const std::string& reply_text);
